...
NetBox Load Balancing can manage five different object types: 
...
In addition, further object types are using to handle Many-to-Many relationships with Netbox IPAddress and IPRange object types. 
These assignment objects are:

* LBServiceAssignment -> IPAddress
* PoolAssignment -> IPRange
...
As Objects can be associated to IP addresses and IP ranges for the purposes of forming a relationship between the Load Balancing object 
...
The same applies to the internal associations relating to health monitors and members, where the associations can be created from 
the pool or health monitor views.

### ScreenShots

IP Addresses
![IPAddress Associations](img/ipaddress.png)

IP Ranges
![IPRange Associations](img/iprange.png)
...
Addresses
![List Load Balancing Services](img/service_list.png)
...
Load Balancing Listeners
![List Load Balancing Listeners](img/listener_list.png)
![View Load Balancing Listener](img/listener.png)

Load Balancing Pools
![List Load Balancing Pools](img/pool_list.png)
![View Load Balancing Pool](img/pool.png)

Load Balancing Members
![List Load Balancing Members](img/member_list.png)
...
Load Balancing Health Monitors
![List Load Balancing Health Monitors](img/monitor_list.png)
